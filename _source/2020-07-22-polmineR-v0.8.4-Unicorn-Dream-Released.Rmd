...
A new version of [polmineR](https://CRAN.R-project.org/package=polmineR) (v0.8.3) is available at CRAN. Why do I call this release "Unicorn Dream"? A unicorn dream is much better than a Unicode nightmare...
...
Although I do not really believe that I will never have a nightshift again caused by encoding issues and problems to handle Unicode, baptising the new polmineR release "Unicorn Dream" expresses my (naive) hopes for a bright future and that encoding issues were ghosts haunting me only in the past.
